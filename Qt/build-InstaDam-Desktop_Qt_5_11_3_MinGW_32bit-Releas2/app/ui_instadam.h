...
public:
    ...
    void setupUi(QMainWindow *InstaDam)
    {
        ...
        gridLayout_3->addWidget(addSelectionButton, 6, 24, 1, 1);
        ...
        photoViewTime->setMaximumSize(QSize(30, 22));
        photoViewTime->setFrameShape(QFrame::NoFrame);

        gridLayout_3->addWidget(photoViewTime, 6, 19, 1, 1);
        ...
        gridLayout_3->addItem(horizontalSpacer_2, 6, 22, 1, 1);
        ...
        gridLayout_3->addWidget(showMaskSelections, 6, 29, 1, 1);
        ...
        gridLayout_3->addWidget(filterOptions, 6, 23, 1, 1);
        ...
        pause = new QPushButton(frame_4);
        pause->setObjectName(QStringLiteral("pause"));
        pause->setMaximumSize(QSize(37, 16777215));

        gridLayout_3->addWidget(pause, 6, 18, 1, 1);
    ...
    void retranslateUi(QMainWindow *InstaDam)
    {
        ...
        pause->setText(QApplication::translate("InstaDam", "Pause", nullptr));
