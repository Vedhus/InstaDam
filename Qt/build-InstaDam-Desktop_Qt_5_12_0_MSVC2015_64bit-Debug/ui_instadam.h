...
public:
    ...
    void setupUi(QMainWindow *InstaDam)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 148, 770));
        ...
        graphicsView_2 = new QGraphicsView(splitter_3);
        graphicsView_2->setObjectName(QString::fromUtf8("graphicsView_2"));
        splitter_3->addWidget(graphicsView_2);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1550, 198));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 1550, 198));
        ...
        menubar->setGeometry(QRect(0, 0, 1556, 20));
    ...
    void retranslateUi(QMainWindow *InstaDam)
    {
        ...
        action_Open->setText(QApplication::translate("InstaDam", "&Open", nullptr));
