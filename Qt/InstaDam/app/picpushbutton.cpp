...
void PicPushButton::resetPixmaps(QPixmap pixmap_input)
{
    ...
    pixmap = pixmap_input;
    pixmap_hover = joinPixmaps(pixmap, pixmap_hover, QPainter::CompositionMode_SourceOver);
    pixmap_pressed = joinPixmaps(pixmap, pixmap_pressed, QPainter::CompositionMode_SourceOver);
}
